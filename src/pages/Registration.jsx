    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-gray-50">
      <div className="flex w-full max-w-4xl rounded-lg shadow-2xl overflow-hidden m-4">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 bg-white text-right">
          <h1 className="text-3xl font-extrabold text-gray-800 text-center mb-8">ایجاد حساب کاربری</h1>
          <Formik
          ...
          >
            {({ isSubmitting, values }) => (
              <Form>
                <div className="mb-4">
                  <label htmlFor="username" className="block text-gray-700 font-bold mb-2">نام کاربری</label>
                  <Field type="text" name="username" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500" />
                ...
                <div className="mb-4">
                  ...
                  <Field type="password" name="password" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500" />
                  <PasswordStrengthMeter password={values.password} />
                  <ErrorMessage name="password" component="div" className="text-red-500 text-sm mt-1" />
                </div>
                <div className="mb-6">
                  <label htmlFor="confirmPassword" className="block text-gray-700 font-bold mb-2">تکرار رمز عبور</label>
                  <Field type="password" name="confirmPassword" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500" />
