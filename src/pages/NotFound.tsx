      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center px-4 pt-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 font-['Pelak']">
              صفحه‌ای که دنبالش می‌گردید پیدا نشد!
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed font-['YekanBakh']">
          ...
          >
            ...
            <Link
              to="/contact"
              className="group flex items-center gap-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 py-4 rounded-xl font-semibold hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-['Pelak']"
            >
          ...
          >
            ...
            <div className="text-sm text-gray-500 font-['YekanBakh']">
