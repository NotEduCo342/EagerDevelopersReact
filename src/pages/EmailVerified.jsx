  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-2">ایمیل شما با موفقیت تایید شد!</h1>
        <p className="text-gray-600 mb-6">اکنون می‌توانید وارد حساب کاربری خود شوید.</p>
        <Link 
          to="/login" 
